...
char *xray_benchmark_progress_tsv_text(const char *tsv) {
  ...
  for (size_t index = 0; index < set.count; ++index) {
    ...
    if (compare_streq(row->operation, "mul-large-cpu-campaign") ||
        ...
        compare_streq(row->operation, "mul-large-toom-cmb-hpocket-pt") ||
        compare_streq(row->operation, "mul-large-toom-cmb-hpocket") ||
        compare_streq(row->operation, "mul-large-toom-cmb-tourn-pt") ||
        compare_streq(row->operation, "mul-large-toom-cmb-tourn") ||
        compare_streq(row->operation, "mul-large-toom-cmb-ttourn-pt") ||
        compare_streq(row->operation, "mul-large-toom-cmb-ttourn") ||
        ...
        compare_streq(row->operation, "mul-large-toom-cmb-troute-pt") ||
        compare_streq(row->operation, "mul-large-toom-cmb-troute") ||
        compare_streq(row->operation, "mul-large-toom-cmb-tctrl-pt") ||
        compare_streq(row->operation, "mul-large-toom-cmb-tctrl") ||
        compare_streq(row->operation, "mul-large-toom-cmb-gmpctrl-pt") ||
        compare_streq(row->operation, "mul-large-toom-cmb-gmpctrl") ||
        compare_streq(row->operation, "mul-large-toom-cmb-gmptrans-pt") ||
        compare_streq(row->operation, "mul-large-toom-cmb-gmptrans") ||
        compare_streq(row->operation, "mul-large-toom-cmb-neg2-pt") ||
        compare_streq(row->operation, "mul-large-toom-cmb-neg2") ||
        compare_streq(row->operation, "mul-large-toom5-top-reuse-pt") ||
        compare_streq(row->operation, "mul-large-toom5-top-reuse") ||
        compare_streq(row->operation, "mul-large-toom5-top-handoff-pt") ||
        compare_streq(row->operation, "mul-large-toom5-top-handoff") ||
        ...
        compare_streq(row->operation, "mul-large-toom4-top-fdiv-pt") ||
        compare_streq(row->operation, "mul-large-toom4-top-fdiv") ||
        compare_streq(row->operation, "mul-large-toom4-top-vs-cmb-pt") ||
        compare_streq(row->operation, "mul-large-toom4-top-vs-cmb") ||
